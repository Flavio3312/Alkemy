...
/**
 * Constant with values for set Income/Expenses.
 * @name ConstIncome/Expense
 * @constant
 * @readonly
 */
 ...
 * @name ValidIncome
 * @see {@link INCOMEOREXPENSE}
 * @param {String} type A boolean to compare.
 * @example
 * isValidIsIncome("INCOME");
 * true
 * @example
 ...
 */
export const isValidINCEXP = (type) => INCOMEOREXPENSE.includes(type);
/**
 * Function to know if isIncome is valid.
 * @name ValidDate
